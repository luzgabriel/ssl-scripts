...
"""This is the script used to generate a new sub CA."""
...
def main():
    ...
    name = x509.Name([
        ...
        x509.NameAttribute(NameOID.COMMON_NAME, u"SUB CA 1"),])
    ...
    with open("subca.crt", "w") as text_file:
    ...
    with open("subca.key", "w") as text_file:
